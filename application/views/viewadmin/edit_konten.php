...
<div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/adminberbol/konten"><i class="fa fa-indent fa-fw nav_icon"></i>Berita</a>
                        </li>
						<li>
	...
	<?php echo form_open_multipart('admin/adminberbol/update/'.$id);?>
	...
	<table class="table table-bordered table-hover table-striped">
		...
		<tr>
			<th>Judul Berita</th>
			<td><input type="text" name="judulberita" placeholder="Edit berita" class="form-control"value="<?php echo $list->judul; ?>" required></td>
		</tr>
		<tr>
			<th>Gambar</th>
			<td>
        ...
        <span class="displaybefore">Before: <img src="<?php echo base_url();?>assets/images/<?php echo $list->urlphoto;?>" class="img-responsive"  id="konten"/></span>
    ...
    <tr>
      ...
      <td><select name="kategori" class="form-control">
              <option value="<?php echo $list->kategori; ?>"><?php echo $list->kategori; ?></option>
		...
		<tr>
			<th>Isi Berita</th>
			<td>
				<textarea class=" ckeditor" placeholder="Edit isi berita" name="isiberita" required> <?php echo $list->isi; ?></textarea>
			</td>
		</tr>
		<tr>
			<th></th>
			<td>
				<input type="submit" value="Edit" class="col-md-offset-11 btn btn-default">
			</td>
		</tr>
	</table>
	<?php }; ?>
